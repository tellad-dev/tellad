      ...
      <v-card class="mx-auto shop-card">
        ...
        <v-row justify="center" no-gutters>
          <FormulateForm v-model="formValues" class="shop-form" @submit="save">
            ...
            <FormulateInput name="reference" type="text" label="来客者参考物" placeholder="" validation="required" />
            <FormulateInput
              ...
              validation="required"
            />
            <FormulateInput name="customerAge" type="text" label="顧客の年齢" placeholder="" validation="required" />
            <FormulateInput
